    ...
    public partial class AddClassPage : WizardPage
    {
        ...
        private void OnBrowseButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            try {
                ...
                iVsUIShell.GetDialogOwnerHwnd(out System.IntPtr owner);
        ...
        private void OnComboBoxSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (!(comboBox.SelectedItem is SortComboBoxItem item) || ClassView == null)
                return;
        ...
        private void OnListViewSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (!(listView.SelectedItem is Class item))
                return;
        ...
        {
            if (!(ClassView.SelectedItem is Class item))
                return;
        ...
        private void OnListViewItemMouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (!((sender as ListViewItem).DataContext is Class item))
                return;
            item.DefaultName = DefaultNameTextBox.Text;
