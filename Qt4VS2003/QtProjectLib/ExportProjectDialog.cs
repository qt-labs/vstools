...
namespace Nokia.QtProjectLib
{
	...
	internal class ExportProjectDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.newButton = new ImageButton(HelperFunctions.GetSharedImage("QtProjectLib.Images.newitem.png"), 
                HelperFunctions.GetSharedImage("QtProjectLib.Images.newitem_d.png"));
            this.delButton = new ImageButton(HelperFunctions.GetSharedImage("QtProjectLib.Images.delete.png"), 
                HelperFunctions.GetSharedImage("QtProjectLib.Images.delete_d.png"));
