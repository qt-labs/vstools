...
print HxC "<HelpCollection DTDVersion=\"1.0\" LangId=\"1033\" Title=\"$title\" FileVersion=\"$fileVersion\" Copyright=\"The Qt Company Ltd\">\n";
...
print HxCCOL "<HelpCollection DTDVersion=\"1.0\" FileVersion=\"$fileVersion\" LangId=\"1033\" Title=\"$title\" Copyright=\"The Qt Company Ltd\">\n";
...
print H2REG "$namespace|$outHxCColFile|Qt Reference Documentaton - qt.io\n";
